...
# This file contains the gymnasium wrapper around env.py for use with RL libraries, e.g. stable baselines3
...
class TruckParkingGymEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        zero_obs = np.zeros_like(obs_vec)
    ...
    def _compute_reward(self) -> Tuple[float, bool, bool, dict]:
        ...
        if trend > 0.02: 
            progress = max(min(prev_dist - dist, 1.0), -1.0)
